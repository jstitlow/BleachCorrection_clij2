...
@Plugin(type = CLIJMacroPlugin.class, name = "CLIJ_bleachCorrection2")
public class BleachCorrection2 extends AbstractCLIJ2Plugin implements CLIJMacroPlugin, CLIJOpenCLProcessor, OffersDocumentation {
